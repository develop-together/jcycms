    ...
    protected function initDefaultButtons()
    {
        ...
        if (! isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key, $index, $gridView) {
                if (Yii::$app->controller->id == 'admin-user') {
                    return @$model->userRole->role_id != AdminRoles::SUPER_ROLE_ID ? Html::a('<i class="fa fa-pencil"></i> ' . Yii::t('app', 'Update'), $url, [
        ...
        if (! isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key, $index, $gridView) {
                if (Yii::$app->controller->id == 'admin-user') {
                    return @$model->userRole->role_id != AdminRoles::SUPER_ROLE_ID ? Html::a('<i class="glyphicon glyphicon-trash" aria-hidden="true"></i> ' . Yii::t('app', 'Delete'), $url, [
