...
class MallSku extends \common\components\BaseModel
{
    ...
    {
        $this->sku_code = substr(uniqid($this->spu_id), 0, 16);
        return parent::beforeSave($insert); // TODO: Change the autogenerated stub
    }

    public function afterFind()
    {
//        $this->images && $this->images = Utils::photoUrl($this->images);
        parent::afterFind(); // TODO: Change the autogenerated stub
    }

    public function getAttachment()
    {
        return Attachment::findOne(['filepath' => $this->images]);
//        return $this->hasOne(Attachment::class, ['filepath' => $this->images]);
    }
}
