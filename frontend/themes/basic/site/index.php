        ...
        <div class="tm-intro">
            <section id="tm-section-1">                        
                <div class="tm-container text-xs-center tm-section-1-inner">
                    <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-lumino-logo.png" alt="Logo" class="tm-logo">
            ...
            <div class="tm-container tm-container-wide">
                <div class="tm-news-item">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 tm-news-item-img-container">
                        <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-600x300-01.jpg" alt="Image" class="img-fluid tm-news-item-img">  
                    </div>
                ...
                <div class="tm-news-item">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 flex-order-2 tm-news-item-img-container">
                        <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-600x300-02.jpg" alt="Image" class="img-fluid tm-news-item-img">
                    </div>
                ...
                <div class="tm-news-item">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 tm-news-item-img-container">
                        <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-600x300-03.jpg" alt="Image" class="img-fluid tm-news-item-img">
                    </div>
            ...
            <div class="tm-container text-xs-center">
                ...
                <div class="tm-img-grid">
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-01.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-01.jpg" alt="Image" class="img-fluid tm-gallery-img"> <!-- 300x200 -->
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-07.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-07.jpg" alt="Image" class="img-fluid tm-gallery-img">  
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-02.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-02.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>                           
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-09.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-09.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-03.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-03.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-08.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-08.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-10.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-10.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-04.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-04.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-05.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-05.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-11.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-11.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-06.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-06.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>
                    </div>
                    <div class="tm-gallery-img-container">
                        <a href="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-12.jpg" class="tm-gallery-img-link">
                            <img src="<?= Yii::$app->request->baseUrl ?>/static/basic/img/tm-450x300-12.jpg" alt="Image" class="img-fluid tm-gallery-img">
                        </a>
                    </div>
                </div>
            </div>
