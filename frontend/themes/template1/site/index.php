...
<div class="template">
  <div class="box">
    ...
    <ul>
      <li><a href="/"  target="_blank"><img src="<?= Yii::$app->request->baseUrl ?>static/template1/images/01.jpg"></a><span>仿新浪博客风格·梅——古典个人博客模板</span></li>
      <li><a href="/" target="_blank"><img src="<?= Yii::$app->request->baseUrl ?>static/template1/images/02.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
      <li><a href="/"  target="_blank"><img src="<?= Yii::$app->request->baseUrl ?>static/template1/images/03.jpg"></a><span>Green绿色小清新的夏天-个人博客模板</span></li>
      <li><a href="/" target="_blank"><img src="<?= Yii::$app->request->baseUrl ?>static/template1/images/04.jpg"></a><span>女生清新个人博客网站模板</span></li>
      <li><a href="/"  target="_blank"><img src="<?= Yii::$app->request->baseUrl ?>static/template1/images/02.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
      <li><a href="/"  target="_blank"><img src="<?= Yii::$app->request->baseUrl ?>static/template1/images/03.jpg"></a><span>Green绿色小清新的夏天-个人博客模板</span></li>
    </ul>
  </div>
