    ...
    <div class="row">
      <div id="tm-section-1" class="tm-section">
        <div class="col-md-12">
            ...
            <img src="<?= Yii::$app->request->baseUrl ?>/static/img/tm-1800x600-01.jpg" class="img-fluid tm-banner-img" alt="Image">            
        </div>
      </div>                
    </div>
        ...
        <div class="tm-section" id="tm-section-3">
            ...
            <div class="col-md-6 margin-bottom-sm-8">  
                <div class="tm-2-col-box-left">
                    <img src="<?= Yii::$app->request->baseUrl ?>/static/img/tm-700x350-01.jpg" alt="Image" class="img-fluid tm-img-2-col">
            ...
            <div class="col-md-6">
                <div>
                    <img src="<?= Yii::$app->request->baseUrl ?>/static/img/tm-700x350-02.jpg" alt="Image" class="img-fluid tm-img-2-col">
        ...
        <div class="tm-section" id="tm-section-4">
            <div class="col-md-4 margin-bottom-sm-3">
                <div class="tm-3-col-box">
                    <img src="<?= Yii::$app->request->baseUrl ?>/static/img/tm-500x250-01.jpg" alt="Image" class="img-fluid">
            ...
            <div class="col-md-4 margin-bottom-sm-3">
                ...
                <div class="tm-3-col-box">
                    <img src="<?= Yii::$app->request->baseUrl ?>/static/img/tm-500x250-02.jpg" alt="Image" class="img-fluid">
            ...
            <div class="col-md-4">
                <div class="tm-3-col-box">
                    <img src="<?= Yii::$app->request->baseUrl ?>/static/img/tm-500x250-03.jpg" alt="Image" class="img-fluid">
